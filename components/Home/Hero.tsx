    ...
    <div className='w-full h-[calc(100vh-12vh)] flex justify-center flex-col'>
        ...
        <div>
            ...
            <p className='text-sm md:text-base lg:text-lg text-black text-opacity-70 mt-4'>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Saepe aliquid dolor non similique sequi iste, beatae maiores quaerat nemo libero voluptates cupiditate rem cum quidem molestias provident dolorem id minus!
            </p>
        ...
        <div className='hidden lg:block'>
            ...
            alt='hero' width={600} height={600} 
            className='lg:h-[50%] lg:w-[50%] xl:h-[80%]' />
        </div>
        </div>
    </div>
  );
